...
#     --output-dir "plots/ablation/jetclass-ddp-fast-wqq-rawlejepa"
...
#     --prefetch-factor 2 \
#     --shuffle-active-shards 4 \
#     --output-dir "plots/ablation/jetclass-ddp-fast-wqq-lejepa+triplet"
...
#     --prefetch-factor 2 \
#     --shuffle-active-shards 4 \
#     --output-dir "plots/ablation/jetclass-ddp-fast-wqq-lejepa+classification"
...
python -u \
    ...
    --prefetch-factor 2 \
    --shuffle-active-shards 4 \
    --output-dir "plots/ablation/jetclass-ddp-fast-wqq-lejepa+triplet+classification"