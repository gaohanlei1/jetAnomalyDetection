...
# SBATCH --nodelist=gpu3004      # the L40S GPU!! 3001-3005, 3101-3102, 2708 are L40S
...
python -u \
    ...
    --output-dir "plots/quickrun/all-jetclass-half"

python -u \
    scripts/diagnose_lejepa_latents.py \
    "plots/quickrun/all-jetclass-half"


python -u \
    scripts/run_train_lejepa_part.py \
    --dataset cms \
    --dataset-root "/HEP/export/home/hgao50/jet-anomaly-data/ak8-v3" \
    --model semi-sup-triplet \
    --checkpoint "plots/quickrun/all-jetclass-half/best_checkpoint.pt" \
    --checkpoint-summary "plots/quickrun/all-jetclass-half/summary.json" \
    ...
    --prefetch-factor 2 \
    --shuffle-active-shards 4 \
    --output-dir "plots/quickrun/all-cms-mc-otherhalf"

python -u \
    scripts/diagnose_lejepa_latents.py \
    "plots/quickrun/all-cms-mc-otherhalf"
